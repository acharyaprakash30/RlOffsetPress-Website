  ...
  return (
    <div className={`navbar ${barscroll ? 'navbar-color' : ''}`}>
      ...
      <ul className='navbar-links'>
        ...
        <ul className={featurelist?'navbar-subs':'navbar-sub'}>
        ...
        <ul className={servicelist?'navbar-subs':'navbar-sub'}>
      ...
      <ul className='navbar-address'>
        <li className='navbar-li-add'><svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mt-1 mr-1 color-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
